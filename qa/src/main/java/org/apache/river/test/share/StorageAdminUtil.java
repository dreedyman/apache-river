 ...
 * @see org.apache.river.admin.StorageLocationAdmin
 */
public class StorageAdminUtil {
     ...
     *  <code>org.apache.river.admin.StorageLocationAdmin</code> interfaces,
     *  and if yes, returns a proxy to an instance of the
     *  <code>org.apache.river.admin.StorageLocationAdmin</code> interface.
     * 
     *  @param serviceObj instance of an object that implements both
     *                    <code>net.jini.admin.Administrable</code> and
     *                    <code>org.apache.river.admin.StorageLocationAdmin</code>,
     ...
     *
     *  @return a <code>org.apache.river.admin.StorageLocationAdmin</code> instance
                                                      ...
                                                      TestException
    {
        ...
        Class storageAdminClass
                   = Class.forName("org.apache.river.admin.StorageLocationAdmin");
        ...
        if( !storageAdminClass.isAssignableFrom(admin.getClass()) ) {
            throw new TestException("the service under test "
                                      +"does not implement the "
                                    +"org.apache.river.admin.StorageLocationAdmin "
                                      +"interface");
        }
