...
public class AttributesUtil {
     ...
     * 
     *  @param config <code>org.apache.river.qa.harness.QAConfig</code> instance
	...
	try {
	    Class c = Class.forName("org.apache.river.constants.VersionConstants");
    ...
    /** Using either values contained in the configure property file, or
     *  default values, constructs and returns an instance of the attribute
     *  class <code>org.apache.river.lookup.entry.BasicServiceType</code>.
     * 
     *  @param config <code>org.apache.river.qa.harness.QAConfig</code> instance
     *                through which the pertinent values in the configuration
     *                file are retrieved
     *
     *  @return <code>org.apache.river.lookup.entry.BasicServiceType</code>
    ...
    public static Entry getBasicServiceTypeFromConfig(QAConfig config) {
        String type = config.getStringConfigVal
                           ("org.apache.river.lookup.entry.BasicServiceType.type",
                            "Jini(TM) Service");
        return new BasicServiceType(type);
    }//end getBasicServiceTypeFromConfig

    /** Using an instance of <code>org.apache.river.qa.harness.QATestUtil</code>,
     ...
     *  uses an instance of <code>org.apache.river.qa.harness.QATestUtil</code> to
